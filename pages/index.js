  ...
  return (
    <>
      ...
      <div style={{maxWidth:430,margin:"0 auto",minHeight:"100vh",background:C.bg,overflowX:"hidden"}}>
        ...
        {screen==="ingredients"&&<IngredientsPage onBack={()=>setScreen("splash")} onNext={(ings,must,noShop)=>{setIngredients(ings);setMustUse(must||[]);setNoShopping(noShop||false);setScreen("preferences");}} onSkip={(ings,noShop)=>{setIngredients([]);setMustUse([]);setNoShopping(false);setScreen("preferences");}}/>}
